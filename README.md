![Go](https://github.com/dmmarkov/ygot/workflows/Go/badge.svg?branch=master)
...
```
go run $GOPATH/src/github.com/dmmarkov/ygot/generator/generator.go -path=yang -output_file=pkg/ocdemo/oc.go -package_name=ocdemo -generate_fakeroot -fakeroot_name=device -compress_paths=true -shorten_enum_leaf_names -typedef_enum_with_defmod -exclude_modules=ietf-interfaces yang/openconfig-interfaces.yang
```
