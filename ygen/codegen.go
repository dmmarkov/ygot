...
type ProtoOpts struct {
	...
	// protobuf file. See
	// https://github.com/dmmarkov/ygot/blob/master/docs/yang-to-protobuf-transformations-spec.md#annotation-of-schema-paths
	...
	// See https://github.com/dmmarkov/ygot/blob/master/docs/yang-to-protobuf-transformations-spec.md#annotation-of-enums
...
func createFakeRoot(structs map[string]*yang.Entry, rootElems []*yang.Entry, rootName string, compressPaths bool) error {
	...
	for _, s := range findRootEntries(structs, compressPaths) {
		if _, ok := fakeRoot.Dir[s.Name]; ok {
			newName := s.Name + "_"

			fakeRoot.Dir[newName] = s
